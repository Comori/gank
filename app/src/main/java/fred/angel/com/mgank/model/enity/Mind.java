...
public class Mind extends BaseModel{
     ...
     * hp_makettime : 2016-08-31 21:00:00
     * hide_flag : 0
     ...
     * template_category : 0
     * maketime : 2016-08-31 21:00:00
     * share_list : {"wx":{"title":"","desc":"","link":"","imgUrl":""},"weibo":{"title":"ONE·一个 那些腼腆的单身喵，大都有一堆表情包。为了那个喜欢的人而存的：知道不可能，知道得不到，既然不能深情也不能矫情，让我以逗B的身份留在你身边好不好。by 大冰 下载ONE·一个APP:http://weibo.com/p/100404157874","desc":"","link":"","imgUrl":""},"qq":{"title":"","desc":"","link":"","imgUrl":""}}
     * praisenum : 38874
     * sharenum : 4165
     * commentnum : 693
     */
    ...
    public static class ShareListBean {
         ...
         * weibo : {"title":"ONE·一个 那些腼腆的单身喵，大都有一堆表情包。为了那个喜欢的人而存的：知道不可能，知道得不到，既然不能深情也不能矫情，让我以逗B的身份留在你身边好不好。by 大冰 下载ONE·一个APP:http://weibo.com/p/100404157874","desc":"","link":"","imgUrl":""}
         * qq : {"title":"","desc":"","link":"","imgUrl":""}
         */

        private ShareBean wx;
        ...
        public void setWx(ShareBean wx) {
            this.wx = wx;
        }
